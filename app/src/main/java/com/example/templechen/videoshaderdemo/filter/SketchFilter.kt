...
class SketchFilter(context: Context, oesTextureId: Int) : BaseFilter(context, oesTextureId) {
    ...
    override fun initProgram() {
        ...
        fragmentShader = GLUtils.loadShader(
            ...
            GLUtils.readShaderFromResource(context, R.raw.sketch_fragment_shader)
        )
