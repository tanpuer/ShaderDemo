...
public class ExoPlayerTool implements IExoPlayer {
    ...
    private PlayerCacheServer cacheServer;

    private ExoPlayerTool(Context context) {
        mExoPlayer = ExoPlayerFactory.newSimpleInstance(context);
        mExoPlayer.setForegroundMode(true);
        cacheServer = PlayerCacheServer.Companion.getInstance(context.getApplicationContext());
    }
    ...
    public void quickSetting(Context context, String url) {
        ...
        if (url.startsWith("http://") || url.startsWith("https://")) {
            quickSetting(context, cacheServer.getProxyUrl(url), null);
        } else {
