 ...
 * a bottom sheet.
 */
public class CoverHeaderScrollBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
...
//        }
    ...
    public static <V extends View> CoverHeaderScrollBehavior<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof CoverHeaderScrollBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with CoverHeaderScrollBehavior");
        }
        return (CoverHeaderScrollBehavior<V>) behavior;
    }
